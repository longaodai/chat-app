...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              <div className="size-12 rounder-xl bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
      ...
      <AuthImagePattern
        title="Welcome back!"
        subtitle="Sign in to continue your conversation and catch up with your message."
      />
    </div>
  );
};
